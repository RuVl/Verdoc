...
> **После R5 этот документ — история.** Приложения и их таблицы дропнуты
> ([`r5.md`](./r5.md)), поэтому все сверочные запросы ниже читают то, чего больше нет. Прогонять
> их надо было до наката R5; сейчас они не выполнятся.
