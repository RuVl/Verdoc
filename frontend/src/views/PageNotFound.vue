      ...
      <div class="page-not-found">
        <div>
          <svg class="paper" viewBox="0 0 300 300" width="300px" height="300px" role="img" aria-label="A piece of paper torn in half">
            <g class="paper__outline" fill="none" stroke="hsl(0,10%,10%)" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"
              ...
              <g class="paper__top" transform="translate(0,25)">
                <polygon class="paper__shadow" fill="hsl(0,10%,70%)" stroke="none"
                         points="0 148,0 0,137 0,187 50,187 148,155 138,124 148,93 138,62 148,31 138" transform="translate(-12,12)"/>
        ...
        <div>
          <h1>404</h1>
          <p>{{ $t('other.page_not_found') }}</p>
          <CommonButton class="btn-link" href="main">{{ $t('buttons.go_back_home') }}</CommonButton>
        </div>
      </div>
    </div>
  </teleport>
...
.wrapper {
  ...
  font: 500 1em / 1.5 'Montserrat', sans-serif;
