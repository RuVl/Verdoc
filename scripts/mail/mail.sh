...
# opendkim genkey
sudo mkdir -p /etc/opendkim/keys/verif-docs.com
sudo opendkim-genkey -s mail -b 1024 -d verif-docs.com -D /etc/opendkim/keys/verif-docs.com -v
...
cat /etc/opendkim/keys/verif-docs.com/mail.txt
